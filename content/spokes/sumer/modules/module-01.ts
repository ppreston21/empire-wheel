...
export const moduleOne: ModuleContent = {
  ...
  sourceLedger: [
    ...
    },
    {
      ...
      creator: "Robert A. Carter and Graham Philip · Institute for the Study of Ancient Cultures, University of Chicago",
      resourceType: "Open scholarly chapter · PDF",
      url: "https://isac.uchicago.edu/research/publications/saoc/saoc-63-beyond-ubaid-transformation-and-integration-late-prehistoric",
    ...
    {
      id: "stein-2010-local-identities",
      state: "source-checked",
      title: "Local Identities and Interaction Spheres: Modeling Regional Variation in the Ubaid Horizon",
      creator: "Gil J. Stein · Institute for the Study of Ancient Cultures, University of Chicago",
      resourceType: "Open scholarly chapter · PDF",
      url: "https://isac.uchicago.edu/research/publications/saoc/saoc-63-beyond-ubaid-transformation-and-integration-late-prehistoric",
      learnerPurpose: "Test a regional-interaction model against evidence for local variation instead of treating the Ubaid as one uniform society.",
      expectedTimeMinutes: 25,
      accessStatus: "open",
      verificationDate: "2026-08-13",
    },
  ...
  resources: [
    {
      ...
      citation: "Carter, Robert A., and Graham Philip. “Deconstructing the Ubaid.” In Beyond the Ubaid, edited by Robert A. Carter and Graham Philip, 1–22. SAOC 63. Chicago: The Oriental Institute, 2010.",
      locator: "Chapter 1, “Deconstructing the Ubaid,” pp. 1–10 (PDF pp. 11–20)",
      readingUrl: "https://isac.uchicago.edu/sites/default/files/uploads/shared/docs/saoc63.pdf#page=11",
      ...
      centralQuestionConnection: "The chapter asks whether one label hides locally diverse communities, helping you decide what kinds of change can responsibly be described at a regional scale.",
      guide: {
        authorArgument: "Carter and Philip treat “Ubaid” as an archaeological label that must be tested rather than a single people or uniform culture. They emphasize locally varied developments and question simple core-to-periphery explanations.",
        evidenceToNotice: [
          "How the authors separate a pottery style, a chronological period, and an assumed archaeological culture.",
          "Why similarities in material culture do not automatically identify a shared political organization.",
          "Where the chapter contrasts a southern core model with interaction, exchange, and local choice.",
        ],
        vocabulary: [
          { term: "horizon", context: "A broad distribution of related material traits; it is a descriptive pattern, not proof of one society." },
          { term: "core–periphery", context: "A model in which innovations or influence move outward from a dominant center." },
          { term: "interaction sphere", context: "A framework for studying connections among communities without assuming political unity." },
        ],
        questionsAndLimits: [
          "Which parts of the authors’ case concern archaeological terminology, and which concern past social relationships?",
          "The chapter ranges far beyond southern Mesopotamia; do not use its regional synthesis alone to claim how a particular settlement was governed.",
        ],
      },
      unavailableFallback: {
        learnerTask: "Build a three-column note headed label, observation, and inference. Use the guide below to list what each term would require you to demonstrate.",
        guidance: [
          "Treat “Ubaid” first as a modern classification, not as the name of a known state or ethnic group.",
          "Ask whether shared pottery establishes interaction, identity, political control, or only a material similarity.",
          "Record one claim that would require evidence from a specific site rather than a regional label.",
        ],
      },
    },
    {
      id: "read-stein-local-identities",
      reviewState: "source-checked",
      sourceId: "stein-2010-local-identities",
      citation: "Stein, Gil J. “Local Identities and Interaction Spheres: Modeling Regional Variation in the Ubaid Horizon.” In Beyond the Ubaid, edited by Robert A. Carter and Graham Philip, 23–44. SAOC 63. Chicago: The Oriental Institute, 2010.",
      locator: "Chapter 2, pp. 23–35 (PDF pp. 33–45), through “Ubaid Ritual and Ideology”",
      readingUrl: "https://isac.uchicago.edu/sites/default/files/uploads/shared/docs/saoc63.pdf#page=33",
      learnerQuestion: "How does regional variation change what shared Ubaid material can establish about social and political organization?",
      centralQuestionConnection: "Stein’s comparison makes scale itself part of the problem: patterns shared across regions can coexist with different local economies, institutions, and forms of authority.",
      guide: {
        authorArgument: "Stein argues that the Ubaid horizon joined materially connected but heterogeneous regions. Any explanation of interaction must therefore account for local variation rather than combine evidence from different regions into one imaginary social type.",
        evidenceToNotice: [
          "The eight geographic zones Stein distinguishes and the kinds of variation he compares among them.",
          "His warning about assembling architecture, households, and settlement data from separate regions into a single composite society.",
          "How local adoption and selective sharing complicate a one-way expansion model.",
        ],
        vocabulary: [
          { term: "heterogeneity", context: "Meaningful variation among communities that share some material styles." },
          { term: "composite picture", context: "A reconstruction made by combining evidence from different places; Stein warns that it may describe no society that actually existed." },
          { term: "selective appropriation", context: "Local communities adopting particular practices or objects without adopting an entire social system." },
        ],
        questionsAndLimits: [
          "What evidence would distinguish interaction among peers from influence exerted by a dominant center?",
          "Stein’s model identifies variation, but the assigned section does not resolve every local mechanism or reconstruct a single causal path to Uruk urbanism.",
        ],
      },
      unavailableFallback: {
        learnerTask: "Sketch two competing models: uniform expansion and heterogeneous interaction. Under each, note what evidence you would expect at a local site.",
        guidance: [
          "Do not combine observations from different regions as though they came from one settlement.",
          "Shared styles can show connection while economic and political organization remain locally different.",
          "Carry one unresolved question about the direction or mechanism of interaction into the evidence lab.",
        ],
      },
    },
  ],
